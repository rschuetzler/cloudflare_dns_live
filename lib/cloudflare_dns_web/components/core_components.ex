defmodule CloudflareDnsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CloudflareDnsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CloudflareDnsWeb.Gettext, "errors", msg, opts)
    end
  end
